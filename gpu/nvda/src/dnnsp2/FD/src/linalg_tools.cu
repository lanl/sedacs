                                  ...
                                  ,cudaStream_t cuStrm)
{
    ...
    //std::cout << "Strace ERROR: " << cudaGetErrorString(cudaPeekAtLastError()) << std::endl;
...
/**
    ...
    of size N
**/
cudaError_t linalgtools::computeSnp1(const unsigned N
                                   ,const float* Sig
                                   ,const float* A
                                   ,const float* B
...
cudaError_t linalgtools::computeSigma(unsigned Nocc
    ...
    //std::cout << "sigma ERROR: " << cudaGetErrorString(cudaPeekAtLastError()) << std::endl;
