...
if __name__=="__main__":  #execute main script only when directly called from the command line
    ...
    for layer in range(maxlayer):
        ...
        print(layer, "0th order Idemp error estimate:" + str(idemp_err[layer]))  # Can reach 0 exactely in low precision arithmetics
        print(layer, "1st order Idemp error estimate:" + str(idemp_err_1[layer]))  # Can reach 0 exactely in low precision arithmetics
