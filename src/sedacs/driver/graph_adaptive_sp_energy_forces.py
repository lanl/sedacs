...
#
def get_singlePoint_energy_forces(sdc, eng, rank, numranks, comm, parts, partsCoreHalo, sy, hindex, gscf, mu=0.0):
...
def get_sp_energy_forces(sdc, eng, comm, rank, numranks, sy, hindex, graphNL, mu):
    fullGraph = graphNL
    ...
    fullGraphRho,sy.charges,evals,dvals,energy,forces,subSysOnRank,mu = get_singlePoint_energy_forces(sdc, eng, rank, numranks, comm, parts, partsCoreHalo, sy, hindex, gscf, mu)
    energy = energy - ecoul
    forces = forces + fcoul
