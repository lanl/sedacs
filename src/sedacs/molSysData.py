...
from sedacs.interface_pyseqm import get_molecule_pyseqm, get_coreHalo_ham_inds, get_eVals_pyseqm, pyseqmObjects
import numpy as np
...
# @verbose Verbosity
#
def get_molSysData(eng, sdc, coords,symbols,atomTypes):
    ...
    # Tight interface using modules or an external code compiled as a library
        ...
        return pyseqmObjects(sdc, coords,symbols,atomTypes)
